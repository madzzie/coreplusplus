 ...
 */
var app = angular.module('corePlusPlusApp', [
  'ngRoute'
]);
...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/forum", {templateUrl: "partials/forum.html", controller: "PageCtrl"})
    ...
    .when("/account", {templateUrl: "partials/account.html", controller: "PageCtrl"})
